...
var UpdateUserAvatartService = /** @class */ (function () {
    function UpdateUserAvatartService() {
    }
    // eslint-disable-next-line camelcase
    UpdateUserAvatartService.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default(' Only authenticated users cans change avatar', 401);
                        }
    ...
    return UpdateUserAvatartService;
}());
exports.default = UpdateUserAvatartService;
